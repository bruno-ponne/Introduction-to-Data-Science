...
# Function load_ideb_lsecondary()
# This function loads IDEB data for Lower Secondary Schools

load_ideb_lsecondary <- function(){
  df <- read_excel("data.nosync/ideb_lower_sec_school.xlsx") %>% 
